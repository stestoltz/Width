...
commands = {
    ...
    "2101": stack.append(max(stack)),
    "2102": stack.append(stack.count(stack.pop())),
    "2110": stack.append(sum(stack) / len(stack)),
    "2111": 0,
    "2112": 0,
    "2120": 0,
    "2121": 0,
    "2122": 0,
    "2200": stack.append(stack.pop(-3).replace(stack.pop(-2), stack.pop())),
    "2201": stack.append(stack.pop(-3).replace(stack.pop(-2), stack.pop(), 1)),
    "2202": stack.append(stack.pop(-2).replace(stack.pop(), "")),
    "2210": stack.append(stack.pop(-2).replace(stack.pop(), "", 1)),
    "2211": 0,
    "2212": stack.append(eval(stack.pop())),
    "2220": stack.append(eval(input())),
